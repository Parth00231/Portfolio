...
const SOCIALS = [
  {
    name: 'GitHub',
    handle: '@Parth00231',
    description: 'Explore repositories & open source code',
  ...
  {
    name: 'LinkedIn',
    handle: 'Parth Rastogi',
    description: 'Professional updates & network connections',
    url: 'https://www.linkedin.com/in/parth-rastogi-7186ba336',
    color: '#38bdf8',
    badge: 'Network & Career',
    icon: (
      <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
...
export default function Connect() {
  ...
  return (
    <section id="connect" className="py-32 px-6 relative z-10 border-t border-white/5 bg-space-950/40">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-display font-bold text-white tracking-wider">
            DIGITAL <span className="bg-gradient-to-r from-cyan-400 via-sky-300 to-indigo-400 bg-clip-text text-transparent">PRESENCE</span>
          </h2>
          
          <p className="text-slate-400 max-w-xl mx-auto text-sm md:text-base font-light">
            Connect across my primary development pipelines, professional networks, and algorithm profiles.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {SOCIALS.map((social, idx) => (
            <motion.a
              ...
              className="group relative rounded-2xl bg-space-900/60 border border-white/10 hover:border-cyan-400/40 backdrop-blur-xl p-7 transition-all duration-300 hover:-translate-y-2 shadow-lg hover:shadow-[0_0_30px_rgba(14,165,233,0.15)] flex flex-col justify-between overflow-hidden"
            >
              {/* Corner Cyber Brackets */}
              <div className="cyber-bracket-tl" />
              <div className="cyber-bracket-br" />

              {/* Radial ambient hover glow */}
              <div 
                className="absolute -inset-10 opacity-0 group-hover:opacity-15 transition-opacity duration-500 rounded-full blur-2xl pointer-events-none"
              ...
              <div>
                <div className="flex items-center mb-6">
                  <div 
                    className="p-3.5 rounded-xl bg-space-850 border border-white/10 transition-transform group-hover:scale-110"
                ...
                <p className="text-xs font-mono text-cyan-400/80 mb-3">{social.handle}</p>
